...
Ext.ClassManager.addNameAlternateMappings({
  "BqeApp.controller.commercialManage.CommercialManagerController": [],
  "BqeApp.controller.dailyOffice.ApplyMangerController": [],
  "BqeApp.controller.dailyOffice.AttendanceManageController": [],
  "BqeApp.controller.dailyOffice.ReportQueryController": [],
  "BqeApp.controller.dailyOffice.WorkReportController": [],
  "BqeApp.controller.fastOperate.FastOperationMainController": [],
  "BqeApp.controller.main.AssistantNavigationController": [],
  "BqeApp.controller.main.BqeAssistantMainController": [],
  "BqeApp.controller.resourceManager.BusinessopportunityUploadController": [],
  "BqeApp.controller.resourceManager.PhotographUploadController": [],
  "BqeApp.model.ArticleListModel": [],
  "BqeApp.model.AttendanceQueryModel": [],
  "BqeApp.model.CategoriesModel": [],
  "BqeApp.model.CustomerInfoModel": [],
  "BqeApp.model.FunctionListModel": [],
  "BqeApp.model.LoginModel": [],
  "BqeApp.model.WorkReportModel": [],
  "BqeApp.store.ArticleListStore": [],
  "BqeApp.store.CustomerContactJsonPStore": [],
  "BqeApp.store.LoginStore": [],
  "BqeApp.store.PushCardTypeStore": [],
  "BqeApp.store.ReportQueryJsonPStore": [],
  "BqeApp.store.WorkReportJsonPStore": [],
  "BqeApp.store.attendanceQueryJsonPStore": [],
  "BqeApp.store.functionListStore.ApplyManageStore": [],
  "BqeApp.store.functionListStore.AttendanceManageStore": [],
  "BqeApp.store.functionListStore.CommercialManagementStore": [],
  "BqeApp.store.functionListStore.DailyOfficeStore": [],
  "BqeApp.store.functionListStore.FastOperationStore": [],
  "BqeApp.store.functionListStore.PriceManageStore": [],
  "BqeApp.store.functionListStore.ResourcesManagementStore": [],
  "BqeApp.store.functionListStore.SystemSettingsStore": [],
  "BqeApp.view.commercialManager.CommercialManageMain": [],
  "BqeApp.view.commercialManager.customer.CustomerDetailsPanel": [],
  "BqeApp.view.commercialManager.customer.CustomerManageList": [],
  "BqeApp.view.commercialManager.priceManage.PriceManageMian": [],
  "BqeApp.view.dailyOffice.DailyOfficeMain": [],
  "BqeApp.view.dailyOffice.WorkReport": [
    "WorkReport"
  ],
  "BqeApp.view.dailyOffice.announcement.AnnouncementQuery": [],
  "BqeApp.view.dailyOffice.applyManage.ApplyManageMain": [],
  "BqeApp.view.dailyOffice.applyManage.ApplyQuery": [],
  "BqeApp.view.dailyOffice.applyManage.CommitApply": [],
  "BqeApp.view.dailyOffice.attendance.AttendanceManage": [],
  "BqeApp.view.dailyOffice.attendance.pushcard.PushCardDetail": [],
  "BqeApp.view.dailyOffice.attendance.pushcard.PushCardType": [],
  "BqeApp.view.dailyOffice.attendance.query.AttendanceQueryDetail": [],
  "BqeApp.view.dailyOffice.attendance.query.AttendanceQueryView": [],
  "BqeApp.view.fastOperate.FastOperationMain": [],
  "BqeApp.view.fastOperate.FastOperationSetting": [],
  "BqeApp.view.main.AssistantNavigation": [],
  "BqeApp.view.main.BqeAssistantMainPanel": [],
  "BqeApp.view.main.HomeTabPanel": [],
  "BqeApp.view.main.LoginPanel": [],
  "BqeApp.view.main.SlidingMenu": [],
  "BqeApp.view.main.SystemSettingList": [],
  "BqeApp.view.resourceManager.BusinessopportunityUpload": [],
  "BqeApp.view.resourceManager.PhotographUpload": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "BqeApp.store.functionListStore.SystemSettingsStore": [],
  "BqeApp.view.commercialManager.CommercialManageMain": [
    "widget.commercialmanagemain"
  ],
  "BqeApp.view.commercialManager.customer.CustomerDetailsPanel": [
    "widget.customerdetailspanel"
  ],
  "BqeApp.view.commercialManager.customer.CustomerManageList": [
    "widget.customermanagelist"
  ],
  "BqeApp.view.commercialManager.priceManage.PriceManageMian": [
    "widget.pricemanagemian"
  ],
  "BqeApp.view.dailyOffice.DailyOfficeMain": [
    "widget.dailyofficemain"
  ],
  "BqeApp.view.dailyOffice.WorkReport": [
    "widget.workreport"
  ],
  "BqeApp.view.dailyOffice.announcement.AnnouncementQuery": [
    "widget.announcementquery"
  ],
  "BqeApp.view.dailyOffice.applyManage.ApplyManageMain": [
    "widget.applymanagemain"
  ],
  "BqeApp.view.dailyOffice.applyManage.ApplyQuery": [
    "widget.applyquery"
  ],
  ...
  "BqeApp.view.dailyOffice.attendance.AttendanceManage": [
    "widget.attendancemanage"
  ],
  "BqeApp.view.dailyOffice.attendance.pushcard.PushCardDetail": [
    "widget.pushcarddetail"
  ],
  "BqeApp.view.dailyOffice.attendance.pushcard.PushCardType": [
    "widget.pushcardtype"
  ],
  "BqeApp.view.dailyOffice.attendance.query.AttendanceQueryDetail": [
    "widget.attendancequerydetail"
  ],
  "BqeApp.view.dailyOffice.attendance.query.AttendanceQueryView": [
    "widget.attendancequeryview"
  ],
  "BqeApp.view.fastOperate.FastOperationMain": [
    "widget.fastoperationmain"
  ],
  "BqeApp.view.fastOperate.FastOperationSetting": [
    "widget.fastoperationsetting"
  ],
  "BqeApp.view.main.AssistantNavigation": [
    "widget.assistantnavigation"
  ],
  "BqeApp.view.main.BqeAssistantMainPanel": [
    "widget.bqeassistantmainpanel"
  ],
  "BqeApp.view.main.HomeTabPanel": [
    "widget.hometabpanel"
  ],
  ...
  "BqeApp.view.main.SystemSettingList": [
    "widget.systemsettinglist"
  ],
  "BqeApp.view.resourceManager.BusinessopportunityUpload": [
    "widget.businessopportunityupload"
  ],
  "BqeApp.view.resourceManager.PhotographUpload": [
    "widget.photographupload"
  ],
  "BqeApp.view.resourceManager.ResourceManageMain": [
    "widget.resourcemanagemain"
  ],
  "Ext.AbstractComponent": [],
  "Ext.AbstractManager": [],
  "Ext.AbstractPlugin": [],
